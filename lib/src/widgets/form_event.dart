...
Future<EventClient?> eventForm(BuildContext context, List<EventClient> events) {
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ConstrainedBox(
                                          ...
                                          child: TextFormField(
                                            controller: enlaceReunionController,
                                            ...
                                            decoration: const InputDecoration(
                                              ...
                                              disabledBorder: OutlineInputBorder(
                                                // <--- Aquí el borde cuando está deshabilitado
                                                borderSide: BorderSide(
                                                  color: Color(0xFFd9d9d9),
                                                ), // mismo color que enabledBorder o el que quieras
                                              ),
                                              contentPadding:
                                      ...
                                      ElevatedButton(
                                        onPressed: () {
                                          ...
                                          final String duracionMin =
                                              duracionMinController.text.trim();
                                          final String duracionSeg =
                                              duracionSegController.text.trim();
